...
class SharedPreference {
  ...
  void setImageProfile(String image) async {
    SharedPreferences getPref = await _pref;
    getPref.setString('foto_profil', image);
  }

  void setBiodata(String nama, String nim) async {
    SharedPreferences getPref = await _pref;
    getPref.setString('nama', nama);
    getPref.setString('nim', nim);
  }

  static Future<String> getImageProfile() async {
    SharedPreferences getPref = await _pref;
    String image = getPref.getString('foto_profil') ?? "";
    return image;
  }
